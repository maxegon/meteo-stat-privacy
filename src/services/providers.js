...
export const PROVIDERS = {
  ...
  MET_NORWAY: {
    ...
    officialSource: { ente: 'MET Norway — Istituto Meteorologico Norvegese', url: 'https://www.met.no' },
    apiKeyRequired: false,
    free: true,
  ...
  BRIGHTSKY: {
    ...
    officialSource: { ente: 'DWD — Deutscher Wetterdienst (Germania)', url: 'https://www.dwd.de' },
    apiKeyRequired: false,
    free: true,
  ...
  SEVEN_TIMER: {
    ...
    officialSource: { ente: 'NOAA — National Oceanic and Atmospheric Administration (USA)', url: 'https://www.noaa.gov' },
    apiKeyRequired: false,
    free: true,
